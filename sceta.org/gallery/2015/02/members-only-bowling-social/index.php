...
<html class="no-js">
	<head>
		...
		<title>Members-Only Bowling Social &ndash; Feb. 12, 2015 &ndash; Gallery &ndash; SCETA</title>
	...
	<body class="cbp-spmenu-push">
		...
		<div class="not-fullscreen background" id="background" style="background-image:url('img/DSC_0199.jpg');" data-img-width="2005" data-img-height="1333">
			<div class="content-a">
				<div class="content-b gallery">
					<h1>Members-Only Bowling Social</h1>
					<h2>Feb. 12, 2015</h2>
				</div>
			</div>
		</div>
