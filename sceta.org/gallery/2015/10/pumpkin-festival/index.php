...
<html class="no-js">
	<head>
		...
		<title>Pumpkin Festival &ndash; Oct. 17, 2015 &ndash; Gallery &ndash; SCETA</title>
	...
	<body class="cbp-spmenu-push">
		...
		<div class="not-fullscreen background" id="background" style="background-image:url('img/image2.jpg');" data-img-width="3264" data-img-height="2448">
			<div class="content-a">
				<div class="content-b gallery">
					<h1>Pumpkin Festival</h1>
					<h2>Oct. 17, 2015</h2>
				</div>
			</div>
		</div>
