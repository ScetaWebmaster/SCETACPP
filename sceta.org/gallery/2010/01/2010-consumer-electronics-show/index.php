...
<html class="no-js">
	<head>
		...
		<title>2010 Consumer Electronics Show &ndash; Jan. 08, 2010 &ndash; Gallery &ndash; SCETA</title>
	...
	<body class="cbp-spmenu-push">
		...
		<div class="not-fullscreen background" id="background" style="background-image:url('img/013.jpg');" data-img-width="800" data-img-height="600">
			<div class="content-a">
				<div class="content-b gallery">
					<h1>2010 Consumer Electronics Show</h1>
					<h2>Jan. 08, 2010</h2>
				</div>
			</div>
		</div>
