...
<html class="no-js">
	<head>
		...
		<title>Engineering Week Dodgeball Tournament &ndash; Feb. 18, 2010 &ndash; Gallery &ndash; SCETA</title>
	...
	<body class="cbp-spmenu-push">
		...
		<div class="not-fullscreen background" id="background" style="background-image:url('header.jpg');" data-img-width="800" data-img-height="600">
			<div class="content-a">
				<div class="content-b gallery">
					<h1>Engineering Week Dodgeball Tournament</h1>
					<h2>Feb. 18, 2010</h2>
				</div>
			</div>
		</div>
