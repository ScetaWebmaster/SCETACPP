...
<html class="no-js">
	<head>
		...
		<title>Previous SCETA T-shirt Designs &ndash; Oct. 17, 2013 &ndash; Gallery &ndash; SCETA</title>
	...
	<body class="cbp-spmenu-push">
		...
		<div class="not-fullscreen background" id="background" style="background-image:url('header.jpg');" data-img-width="3264" data-img-height="1836">
			<div class="content-a">
				<div class="content-b gallery">
					<h1>Previous SCETA T-shirt Designs</h1>
					<h2>Oct. 17, 2013</h2>
				</div>
			</div>
		</div>
