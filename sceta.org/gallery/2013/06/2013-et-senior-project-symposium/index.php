...
<html class="no-js">
	<head>
		...
		<title>2013 ET Senior Project Symposium &ndash; Jun. 09, 2013 &ndash; Gallery &ndash; SCETA</title>
	...
	<body class="cbp-spmenu-push">
		...
		<div class="not-fullscreen background" id="background" style="background-image:url('header.jpg');" data-img-width="1200" data-img-height="800">
			<div class="content-a">
				<div class="content-b gallery">
					<h1>2013 ET Senior Project Symposium</h1>
					<h2>Jun. 09, 2013</h2>
				</div>
			</div>
		</div>
