...
<html class="no-js">
	<head>
		...
		<title>2013 SCETA Banquet &ndash; Jun. 13, 2013 &ndash; Gallery &ndash; SCETA</title>
	...
	<body class="cbp-spmenu-push">
		...
		<div class="not-fullscreen background" id="background" style="background-image:url('header.jpg');" data-img-width="1092" data-img-height="728">
			<div class="content-a">
				<div class="content-b gallery">
					<h1>2013 SCETA Banquet</h1>
					<h2>Jun. 13, 2013</h2>
				</div>
			</div>
		</div>
