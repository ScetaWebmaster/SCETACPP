...
<html class="no-js">
	<head>
		...
		<title>2nd Annual Alternative Vehicles Exposition &ndash; Mar. 16, 2013 &ndash; Gallery &ndash; SCETA</title>
	...
	<body class="cbp-spmenu-push">
		...
		<div class="not-fullscreen background" id="background" style="background-image:url('header.jpg');" data-img-width="600" data-img-height="400">
			<div class="content-a">
				<div class="content-b gallery">
					<h1>2nd Annual Alternative Vehicles Exposition</h1>
					<h2>Mar. 16, 2013</h2>
				</div>
			</div>
		</div>
