...
<html class="no-js">
	<head>
		...
		<title>2012 Welcome Fair & CPP Lights &ndash; Nov. 10, 2012 &ndash; Gallery &ndash; SCETA</title>
	...
	<body class="cbp-spmenu-push">
		...
		<div class="not-fullscreen background" id="background" style="background-image:url('header.jpg');" data-img-width="960" data-img-height="640">
			<div class="content-a">
				<div class="content-b gallery">
					<h1>2012 Welcome Fair & CPP Lights</h1>
					<h2>Nov. 10, 2012</h2>
				</div>
			</div>
		</div>
