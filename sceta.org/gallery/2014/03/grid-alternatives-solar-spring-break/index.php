...
<html class="no-js">
	<head>
		...
		<title>GRID Alternatives Solar Spring Break &ndash; Mar. 24, 2014 &ndash; Gallery &ndash; SCETA</title>
	...
	<body class="cbp-spmenu-push">
		...
		<div class="not-fullscreen background" id="background" style="background-image:url('header.jpg');" data-img-width="1632" data-img-height="1224">
			<div class="content-a">
				<div class="content-b gallery">
					<h1>GRID Alternatives Solar Spring Break</h1>
					<h2>Mar. 24, 2014</h2>
				</div>
			</div>
		</div>
