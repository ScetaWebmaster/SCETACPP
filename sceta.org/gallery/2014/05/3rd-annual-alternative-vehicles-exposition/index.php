...
<html class="no-js">
	<head>
		...
		<title>3rd Annual Alternative Vehicles Exposition &ndash; May 29, 2014 &ndash; Gallery &ndash; SCETA</title>
	...
	<body class="cbp-spmenu-push">
		...
		<div class="not-fullscreen background" id="background" style="background-image:url('img/DSC_0064.jpg');" data-img-width="3008" data-img-height="2000">
			<div class="content-a">
				<div class="content-b gallery">
					<h1>3rd Annual Alternative Vehicles Exposition</h1>
					<h2>May 29, 2014</h2>
				</div>
			</div>
		</div>
