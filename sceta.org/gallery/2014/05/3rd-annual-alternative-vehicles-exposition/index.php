...
<html class="no-js">
	<head>
		...
		<title>SCETA - Gallery - May 29, 2014 - 3rd Annual Alternative Vehicles Exposition</title>
				...
				<div id="maincontent">
					<div class="section group">
						<div class="col span_1_of_4">
							<?php include '../../../../../inc/sceta.org/sidemenu_members_gallery_4.php'; ?>
						</div>

						<div class="col span_3_of_4">
							<h4>Gallery - May 29, 2014 - 3rd Annual Alternative Vehicles Exposition</h4>
							<?php 
								include_once('../../../resources/UberGallery.php');
								$gallery = UberGallery::init()->createGallery('img');
							?>

							<a href="../../../../gallery/" class="backBarLink">
								<div class="backBar">
