...
<html class="no-js">
	<head>
		...
		<title>Goldstone Tour &ndash; Jun. 06, 2014 &ndash; Gallery &ndash; SCETA</title>
	...
	<body class="cbp-spmenu-push">
		...
		<div class="not-fullscreen background" id="background" style="background-image:url('img/002.jpg');" data-img-width="3008" data-img-height="2000">
			<div class="content-a">
				<div class="content-b gallery">
					<h1>Goldstone Tour</h1>
					<h2>Jun. 06, 2014</h2>
				</div>
			</div>
		</div>
