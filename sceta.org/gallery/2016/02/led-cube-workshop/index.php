...
<html class="no-js">
	<head>
		...
		<title>LED Cube Workshop &ndash; Feb. 20, 2016 &ndash; Gallery &ndash; SCETA</title>
	...
	<body class="cbp-spmenu-push">
		...
		<div class="not-fullscreen background" id="background" style="background-image:url('img/IMG_0497.JPG');" data-img-width="4032" data-img-height="3024">
			<div class="content-a">
				<div class="content-b gallery">
					<h1>LED Cube Workshop</h1>
					<h2>Feb. 20, 2016</h2>
				</div>
			</div>
		</div>
