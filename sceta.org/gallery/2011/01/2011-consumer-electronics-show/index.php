...
<html class="no-js">
	<head>
		...
		<title>2011 Consumer Electronics Show &ndash; Jan. 09, 2011 &ndash; Gallery &ndash; SCETA</title>
	...
	<body class="cbp-spmenu-push">
		...
		<div class="not-fullscreen background" id="background" style="background-image:url('header.jpg');" data-img-width="1280" data-img-height="851">
			<div class="content-a">
				<div class="content-b gallery">
					<h1>2011 Consumer Electronics Show</h1>
					<h2>Jan. 09, 2011</h2>
				</div>
			</div>
		</div>
