...
<html class="no-js">
	<head>
		...
		<title>SCETA - Event Signups</title>
				...
				<div id="maincontent">
					<div class="section group">
						<div class="col span_1_of_4">
							<?php include '../../inc/sceta.org/sidemenu_events_signups.php'; ?>
						</div>

						<div class="col span_3_of_4">
							<h4>Event Signups</h4>
							<p>
								Below are the events available for signups. Some key points of information will be presented on the signup forms, but
								please stay tuned for e-mail updates after signing up.
							</p>
						...
						-->
							...
							<ul>
								<li><a href="https://docs.google.com/forms/d/19l_r_DAxPzbl0jLryebuRfYZ3fEcuN4n5-yARv-Q3uw/viewform" target="_blank">[03/26/15] Show Taping Social/Fundraiser</a></li>
