				...
				<div id="maincontent">
					<div class="section group">
						...
						-->
						    ...
						    <ul>
						    	<li><a href="javascript:void(0);" id="btn_event1">Show Taping Social/Fundraiser (02/24/15)</a></li>
						    	<li><a href="javascript:void(0);" id="btn_event2">Opto22 Tour (03/06/15) ***</a></li>
						    	<li><a href="javascript:void(0);" id="btn_event3">GRID Alternatives Solar Spring Break 2015 (03/23/15) ***</a></li>
						    </ul>
							...
							<h4 class="event1">Show Taping Social/Fundraiser (02/24/15)</h4>
							<ol class="event1">
								<li style="list-style: none;"><img src="../img/ic_loading.gif"></li>
								<script>
									jQuery(function() {
										// Get the list of upcoming events formatted in JSON.
										jQuery.getJSON("https://spreadsheets.google.com/feeds/list/1_Ymd76Hbi6J2pushwgmguHYrLk6s0R3tAdXRxDhZMe4/1/public/values?alt=json&prettyprint=true", function(data) {
							...
							<h4 class="event2">Opto22 Tour (03/06/15) ***</h4>
							<ol class="event2">
								<li style="list-style: none;"><img src="../img/ic_loading.gif"></li>
								<script>
									jQuery(function() {
							...
							<h4 class="event3">GRID Alternatives Solar Spring Break 2015 (03/23/15) ***</h4>
							<ol class="event3">
								<li style="list-style: none;"><img src="../img/ic_loading.gif"></li>
								<script>
									jQuery(function() {
