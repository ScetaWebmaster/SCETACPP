			...
			<div class="container gray">
				<div class="content">
					...
					<p>
						...
						<a href="http://catalog.cpp.edu/content.php?catoid=9&navoid=1139" target="_blank">Cal Poly Pomona's Programs Catalog</a>.
						If you do not see your major listed, please contact our webmaster at
					...
					<form name="contactform" method="post" action="confirm/">
						<fieldset>
							...
							<p>
								<b>Bronco ID number</b>
							</p>

							<p>
								<input name="broncoid" type="tel" size="9" maxlength="9">
							</p>
