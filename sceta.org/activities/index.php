...
<html class="no-js">
	<head>
		...
		<title>SCETA - Other Activities</title>
				...
				<div id="maincontent">
					<div class="section group">
						<div class="col span_1_of_4">
							<?php include '../../inc/sceta.org/sidemenu_events_activities.php'; ?>
						</div>

						<div class="col span_3_of_4">
							<h4>Other Activities</h4>
							<p>
								To be active members of our community, we encourage you to participate in the diverse varieties of events that either we or other clubs hosts as well. 
								This gives you the opportunity to expand your experiences and be a part of a greater and more vast world.
							</p>
