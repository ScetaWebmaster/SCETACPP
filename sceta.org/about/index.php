				...
				<div id="maincontent">
					<div class="section group">
						...
						<div class="col span_3_of_4">
							<h4>About SCETA</h4>
							<p>
								SCETA (Southern California's Engineering Technologists Association) has been networking with 
								engineering alumni who have been working in the engineering field since 1983. SCETA is an association 
								of students interested in life-long learning and the sharing of knowledge among the various engineering 
								disciplines. One of our main goals is to establish a social network for current students, future students, and alumni. 
							</p>
							<p>
								SCETA aims to enrich the college experience for its members and to aid engineering students in becoming holistic engineers through:
								<ul>
									<li>social networking</li>
									<li>maintaining strong alumni connections</li>
									<li>preparing students for industry</li>
									<li>development of leadership, communication, and organization skills</li>
									<li>re-enforcing materials learned in academia through workshops, guest presentations, etc.</li>
								</ul>
							</p>
