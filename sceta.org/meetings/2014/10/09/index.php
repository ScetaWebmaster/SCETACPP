...
<html class="no-js">
	<head>
		...
		<title>1st General Meeting &ndash; Oct. 10, 2014 &ndash; Fall 2014 &ndash; Meetings &ndash; SCETA</title>
	...
	<body class="cbp-spmenu-push">
		...
		<div class="not-fullscreen background" id="background" style="background-image:url('../../../header.jpg');" data-img-width="3008" data-img-height="2000">
			<div class="content-a">
				<div class="content-b gallery">
					<h1>1st General Meeting (Fall 2014)</h1>
					<h2>Oct. 9, 2014</h2>
				</div>
			</div>
		</div>
		...
		<div class="wrapper">
			<div class="container">
				<div class="content">
					<p>
						<iframe src="https://onedrive.live.com/embed?cid=1B130D52F7601F7F&resid=1B130D52F7601F7F%21107&authkey=AF_RnnvMjxuFp3g&em=2" frameborder="0" scrolling="no" id="powerpoint"></iframe>
					<p>
